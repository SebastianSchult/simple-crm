...
import { Timestamp } from '@angular/fire/firestore';  // Falls du mit Firestore arbeitest
...
export class DialogEditDetailsComponent {
  ...
  constructor(public dialogRef: MatDialogRef<DialogEditDetailsComponent>, private firestore: Firestore) {}
